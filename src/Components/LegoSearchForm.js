//stateful component for searching on for "Lego"
...
class Lego extends Component {
    ...
    onInputChange = event => {
        this.setState({ searchText: 'Lego' }); //sets the state to the search value inputed by user
    }

    //handleSubmit - passes user input from the search form up to the perform Search function in app.js
    handleSubmit = event => {
        event.preventDefault();
        this.props.onSearch('Lego'); //invokes onSearch prop (aka performSearch function from app.js) and uses user input to define query
